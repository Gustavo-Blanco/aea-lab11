...
using UniversityCF;
using UniversityCF.Models;

namespace UniversityCF.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(officeAssignments.Where(officeAssigment => officeAssigment.Enable == true).ToList());
        }
